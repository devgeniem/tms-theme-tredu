...
use TMS\Theme\Tredu\PostType\DynamicEvent;
...
class LinkedEvents implements Controller {
    ...
    public static function normalize_event( $event ) : array {
        ...
        return [
            ...
            'provider_title'     => __( 'Organizer', 'tms-theme-tredu' ),
    ...
    public static function get_provider_info( object $event ) : array {
        return [
            ...
            'link'  => [
                ...
                'title' => __( 'Additional info', 'tms-theme-tredu' ),
            ],
        ];
    }
    ...
    public static function get_virtual_event_link( object $event, string $lang_key ) : ?array {
        ...
        return [
            'url'    => $url,
            'title'  => __( 'Virtual event', 'tms-theme-tredu' ),
            'target' => '_blank',
        ];
    }
}
