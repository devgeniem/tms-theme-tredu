    ...
    public function check_password_notice() {
        ...
        if ( $flagged ) {
            $warning = sprintf(
                ...
                __( 'WARNING', 'tms-theme-tredu' ),
                __( 'Your password has been compromised.', 'tms-theme-tredu' ),
                __( 'Please change your password <strong>as soon as possible</strong>.', 'tms-theme-tredu' )
            );
