...
class BlogCategory implements Taxonomy {
    ...
    private function register() {
        $labels = [
            ...
            'separate_items_with_commas' => \__( 'Erottele kategoriat pilkulla', 'tms-theme-tredu' ),
            'add_or_remove_items'        => \__( 'Lisää tai poista kategoria', 'tms-theme-tredu' ),
            'choose_from_most_used'      => \__( 'Suositut kategoriat', 'tms-theme-tredu' ),
            'popular_items'              => \__( 'Suositut kategoriat', 'tms-theme-tredu' ),
