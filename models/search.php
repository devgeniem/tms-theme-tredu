...
class Search extends BaseModel {
    ...
    public function page_title() : string {
        return __( 'Search results', 'tms-theme-tredu' );
    }
    ...
    public function form() {
        ...
        return [
            ...
            'filter_by_post_type' => __( 'Filter by post type', 'tms-theme-tredu' ),
            'filter_by_date'      => __( 'Filter by date', 'tms-theme-tredu' ),
    ...
    private function enrich_results(
        ...
        foreach ( $posts as $post_item ) {
            ...
            apply_filters( 'tms/theme/tredu/search_result_item', $post_item );
        }
