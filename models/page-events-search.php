...
class PageEventsSearch extends BaseModel {
    ...
    public function form() {
        return [
            ...
            'seach_term_label' => __( 'Search term', 'tms-theme-tredu' ),
            'time_frame_label' => __( 'Events from', 'tms-theme-tredu' ),
            'start_date_label' => __( 'Start date', 'tms-theme-tredu' ),
            'end_date_label'   => __( 'End date', 'tms-theme-tredu' ),
    ...
    public function no_results() : ?string {
        return empty( get_query_var( self::EVENT_SEARCH_TEXT ) )
            ? __( 'No search term given', 'tms-theme-tredu' )
            : __( 'No results', 'tms-theme-tredu' );
    }
