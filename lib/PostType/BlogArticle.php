...
class BlogArticle extends Post {
    ...
    public function __construct() {
        $this->description = _x( 'Blog Articles', 'theme CPT', 'tms-theme-tredu' );
    }
    ...
    private function register() {
        $labels = [
            'name'                  => _x( 'Blog Articles', 'theme CPT', 'tms-theme-tredu' ),
            'singular_name'         => _x( 'Blog Article', 'theme CPT', 'tms-theme-tredu' ),
            'menu_name'             => _x( 'Blog Articles', 'theme CPT', 'tms-theme-tredu' ),
            'name_admin_bar'        => _x( 'Blog Articles', 'theme CPT', 'tms-theme-tredu' ),
            'archives'              => 'Arkistot',
